  ...
  export default {
    ...
    data() {
      return {
        ...
        minioUploadUrl: 'http://111.229.115.233:8086/minio/upload?type=1',
      };
    },
    created() {
      if(this.type == 1){
        this.minioUploadUrl = 'http://111.229.115.233:8086/minio/upload?type=1'
      }else{
        this.minioUploadUrl = 'http://111.229.115.233:8086/minio/upload'
      }
    },
    methods: {
      emitInput(val) {
