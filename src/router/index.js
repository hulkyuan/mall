...
},
{
  ...
  },
  {
    path: 'returnAdress',
    name: 'returnAdress',
    component: () => import('@/views/oms/apply/returnAdress'),
    meta: {
      title: '退货地址管理'
    },
    hidden: true
...
},
{
  ...
  children: [{
    path: 'behavior',
    name: 'behavior',
    component: () => import('@/views/algorithm/behavior/index'),
    meta: {
      title: '行为算法管理',
  ...
  },
  {
    path: 'basic',
    name: 'basic',
    component: () => import('@/views/algorithm/basic/index'),
    meta: {
      title: '基础算法管理',
