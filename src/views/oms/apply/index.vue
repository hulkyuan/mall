  ...
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="96px">
          <el-form-item label="用户账号：">
            <el-input v-model="listQuery.memberUsername" class="input-width" placeholder="用户账号" clearable></el-input>
          </el-form-item>
          <el-form-item label="服务单号：">
            <el-input v-model="listQuery.id" class="input-width" placeholder="服务单号" clearable></el-input>
          </el-form-item>
    ...
    <div class="table-container">
      <el-table ref="returnApplyTable" :data="list" style="width: 100%;" @selection-change="handleSelectionChange" v-loading="listLoading" border>
        ...
        <el-table-column label="服务单号" min-width="120" align="center">
          <template slot-scope="scope">{{scope.row.id}}</template>
        </el-table-column>
        <el-table-column label="售后类型" min-width="120" align="center">
        ...
        <el-table-column label="申请退款金额" min-width="120" align="center">
          <template slot-scope="scope">￥{{scope.row.returnAmount}}</template>
        </el-table-column>
        <el-table-column label="实际退款金额" min-width="120" align="center">
          <template slot-scope="scope">{{scope.row.realReturnAmount!==null?'￥'+scope.row.realReturnAmount:'--'}}</template>
        </el-table-column>
