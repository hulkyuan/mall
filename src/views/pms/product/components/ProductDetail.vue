<template> 
  <div class="sub-page-container">
    ...
    <el-card class="form-container" shadow="never" style="padding-left: 0;padding-right: 0;">
      ...
      <product-relation-detail v-show="showStatus[3]" v-model="productParam" :is-edit="isEdit" :is-detail="isDetail"  @prevStep="prevStep" @finishCommit="finishCommit">
