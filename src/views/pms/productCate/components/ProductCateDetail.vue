    ...
    <el-card class="form-container" shadow="never">
      <el-form :model="productCate" :rules="rules" ref="productCateFrom" label-width="150px">
        <el-form-item label="分类名称：" prop="name">
          <el-input v-model="productCate.name" clearable></el-input>
        </el-form-item>
        <el-form-item label="三级分类名称：" prop="threeCategoryName" v-if="isLevel===1||isLevel==='1'">
          <el-input v-model="productCate.threeCategoryName" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item label="数量单位：">
          <el-input v-model="productCate.productUnit" clearable></el-input>
        </el-form-item>
        <el-form-item label="排序：">
          <el-input v-model="productCate.sort" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item label="关键词：">
          <el-input v-model="productCate.keywords" clearable></el-input>
        </el-form-item>
        <el-form-item label="分类描述：">
          <el-input type="textarea" :autosize="true" v-model="productCate.description" clearable></el-input>
        </el-form-item>
        <el-form-item>
